...
- 국내외 특허 만료 예정 블록버스터 의약품과 제네릭/바이오시밀러 기회 (국내 약가 및 시장 규모 포함)
- 약가 동향: 최근 약가 인하/인상, 보험 등재, 급여 확대 관련 이슈
- 국내 물질특허 만료 임박 품목과 원료의약품 소싱 기회 (구체적 품목명, 만료일, 예상 시장규모)
- DMF 동향, 글로벌 API 공급망 이슈, 원료 가격 변동
- 한국 원료의약품 기업에 대한 구체적 시사점과 추천 소싱 타겟
- 구체적인 약물명과 예상 시장 규모 반드시 언급`;
