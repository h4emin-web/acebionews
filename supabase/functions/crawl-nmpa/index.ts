...

{
  ...
  "summary": "4~5문장 이내의 간결한 한국어 요약 (신문 문체 ~했다, ~이다, ~됐다 사용)"
}

요약 작성 규칙:
- title_ko: 중국어 제목을 정확하고 완전하게 한국어로 번역하세요.
- summary: 본문 핵심 내용만 4~5문장 이내로 간결하게 요약하세요.
- 대상 의약품명(성분명/제품명), 해당 기업, 조치 내용, 이유 등 핵심 사실만 포함하세요.
- 内容이 "수입 중단(暂停进口)"인 경우 반드시 중단 대상 품목과 이유를 명시하세요.
- 문장은 완전하게 끝내고 "..."으로 끝내지 마세요.
- 신문 문체(~했다, ~이다, ~됐다, ~한다)로 통일하세요.
- 절대 5문장을 초과하지 마세요. 길게 쓰지 말고 핵심만 압축하세요.`,
          },
          {
            role: "user",
            content: `제목: ${title}\n\n본문:\n${body.slice(0, 4000)}`,
