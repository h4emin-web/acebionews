      ...
      <header className="border-b border-border sticky top-0 z-40 bg-background/80 backdrop-blur-xl">
        <div className="container max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="relative w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-primary/60 flex items-center justify-center shadow-md shadow-primary/20">
              <Pill className="w-5 h-5 text-primary-foreground" />
              <div className="absolute -top-0.5 -right-0.5 w-2.5 h-2.5 rounded-full border-2 border-background" style={{ backgroundColor: 'hsl(160, 60%, 55%)' }} />
            </div>
            <div>
              <h1 className="text-base font-bold text-foreground tracking-tight flex items-center gap-1.5">
                API <span className="text-primary">News</span>
                <span className="text-[9px] font-medium bg-primary/10 text-primary px-1.5 py-0.5 rounded-full tracking-wider uppercase">Live</span>
              </h1>
          ...
          <div className="flex items-center gap-2.5">
            <button
              ...
              className={`flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-xs font-medium border transition-all duration-200 shadow-sm ${
              todayOnly ?
            ...
            <div className="hidden sm:flex items-center gap-1.5 text-[11px] text-muted-foreground/70 shrink-0 bg-muted/50 px-2.5 py-1.5 rounded-lg">
