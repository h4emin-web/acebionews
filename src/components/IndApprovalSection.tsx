...
import { X, Search, Beaker, ChevronDown, Maximize2 } from "lucide-react";
...
const isNew = (approvalDate: string) => {
  const diffMs = new Date().getTime() - new Date(approvalDate).getTime();
...
export const IndApprovalSection = () => {
