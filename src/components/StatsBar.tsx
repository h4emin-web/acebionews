import { Newspaper, FileText, Globe, MapPin } from "lucide-react";
import type { NewsArticle } from "@/hooks/useNewsData";

type Props = {
  news: NewsArticle[];
  totalReports: number;
  regionFilter: "all" | "국내" | "해외" | "리포트";
  onRegionFilterChange: (r: "all" | "국내" | "해외" | "리포트") => void;
};

export const StatsBar = ({ news, totalReports, regionFilter, onRegionFilterChange }: Props) => {
